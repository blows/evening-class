					...
					<footer class="footer">
						<div class="newsletter">
							...
							<div class="social-buttons">
								<ul>
									<li><a href="https://twitter.com/evening_class">Twitter</a></li>
									<li><a href="https://www.facebook.com/eveningclasslondon/">Facebook</a></li>
									<li><a href="mailto:info@evening-class.org">Contact</a></li>
								</ul>
							</div>
						</div>
					</footer>
